...
<body>
 ...
 <hr/>
	...
	<div class="container">
		...
		<div class="form">
			<form action="AdminInsertIntoMenu" method="POST">

				<input type="text" name="itemName" required placeholder="Item Name" autocomplete="off"/>
				<input type="text" name="price" required placeholder="Price" autocomplete="off"/>
