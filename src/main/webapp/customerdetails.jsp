...
<body>
	...
	<div class="sidebar" id="sidebar">
		...
		<a href="CustomerViewOrders">My Orders</a> <a href="customer.jsp">Menu</a><a href="CustomerViewCartItems">Cart (${cartItems })</a>
	...
	<div class="main">
		...
		<form action="CustomerUpdateProfile" method="post">
			...
			<c:forEach items="${customerDetails }" var="c">
				...
				<div class="head1">
					...
					<div class="head">
						<label for="">Customer Id</label> <input type="text"
							value="${c.customerId }" readonly id="customerId" /> <label
							for="">Full Name</label> <input type="text"
							value="${c.customerName }" required placeholder="Full Name"
							name="username" /> <label for="">Gender</label> <select
							name="gender" id="gender"
							onchange="this.className=this.options[this.selectedIndex].className"
							required="required">
							<option value="${c.gender }" selected="selected" hidden="">
								${c.gender}</option>
							<option value="Male" class="optionColor">Male</option>
							<option value="Female" class="optionColor">Female</option>
							<option value="Other" class="optionColor">Other</option>
						</select>
					</div>
				</div>
				<hr id="line" />
				<div class="head2">
					...
					<div class="head">
						<label for="">Email</label> <input type="email"
							placeholder="Email" value="${c.email }" required name="email" />
						...
						<label for="">Contact Number</label> <input type="text"
							...
							placeholder="Contact Number" required value="${c.mobileNumber }"
							oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />

						<label for="">Address</label>
						<textarea rows="4" placeholder="Address" cols="2"
							name="address" required>${c.address }</textarea>
					</div>
				</div>
	...
	<div class="modal hidden">
		...
		<div class="reset">
			<form class="form" method="post" action="CustomerResetPassword">
				<input type="password" required id="pass" placeholder="Enter Password" onkeyup="validatePassword()">
				<input type="password" required id="repass" placeholder="Re-enter Password" name="password" onkeyup="validatePassword()">
				<P id="msg"></P>
...
<%session.removeAttribute("customerPasswordChange");%>