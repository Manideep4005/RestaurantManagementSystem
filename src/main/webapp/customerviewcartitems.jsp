	...
	<div class="container">
		...
		<div class="scroll">
			...
			<table>
				...
				<c:forEach items="${customerViewCartItems }" var="c">
					
					<tr>
						<td>${c.itemName }</td>
						<td>${c.price }</td>
						<td><a href="CustomerCartItemRemove?item=${c.itemId}&cart_item_id=${c.cartItemId}" id="remove">remove</a></td>
					</tr>
	 	...
	 	<c:choose>
			...
			<c:when test="${totalCartValue >= 500 && totalCartValue <= 1000}">
				
				<%
				
					Double price = (Double)session.getAttribute("totalCartValue"); 
					
					double tax = 1;
					
					Double TotalPrice = price + (price * tax / 100);
				%>
				
				<div class="cart_view">
		
					<div class="cart1">
						<p>Price 	   : ${totalCartValue }</p>
						<p>Tax         : 1(%)</p>
						<div id="line"></div>
			...
			<c:when test="${totalCartValue > 1000 && totalCartValue <= 4000}">
			...
			<c:when test="${totalCartValue > 4000}">
			...
			<c:when test="${totalCartValue >=1 && totalCartValue < 500}">
